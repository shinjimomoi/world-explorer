    ...
    <div className="flex flex-1 flex-col overflow-y-auto">
      <div className="mx-auto w-full max-w-xl px-4 py-6 sm:py-8">
        ...
        <div className="mb-4 sm:mb-6">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center gap-1.5 rounded-lg border border-[#333333] text-foreground transition-colors hover:border-[#555555]"
            >
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center gap-1.5 rounded-lg border border-[#333333] text-foreground transition-colors hover:border-[#555555] disabled:opacity-50"
            >
              <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor">
        ...
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 rounded-lg border border-[#333333] py-3 text-sm font-semibold text-foreground transition-colors hover:border-[#555555]"
        >
